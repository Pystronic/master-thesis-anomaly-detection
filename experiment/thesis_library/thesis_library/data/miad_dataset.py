...
class MIADDataset(AnomalibDataset):
    """
    MIAD dataset class.
    ...
    def __init__(
        ...
        self.split = split
        self.samples = make_miad_dataset(
            self.root_category,
            split=self.split,
            extensions=IMG_EXTENSIONS,
        )

def make_miad_dataset(
        root: str | Path,
        split: str | Split | None = None,
    ...
    The files are expected to follow the structure:
        ...
        ``path/to/dataset/category/ground_truth/mask_filename.png``
    ...
    Example:
        >>> root = Path("./datasets/MIAD/electrical_insulator")
        >>> samples = make_miad_dataset(root, split="train")
        >>> samples.head()
           path                               split label image_path           mask_path label_index
        0  datasets/MIAD/electrical_insulator train good  [...]/good/105.png           0
        1  datasets/MIAD/electrical_insulator train good  [...]/good/017.png           0
